...
figure(5)
%Definiton d'erreur Err(delta)=|Tm(2*delta)-Tm(delta)|
...
figure(6)
loglog(d_ar,tini_ar,'-bo',d_ar,tinv_ar,'-ro')
axis square
xlabel('\delta [m]')
ylabel('t [s]')
legend('t_{initialisation}','t_{inversion}')
title('Temps de calcul(initialisation et inversion)')